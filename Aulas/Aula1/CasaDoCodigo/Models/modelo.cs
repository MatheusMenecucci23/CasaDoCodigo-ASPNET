...
namespace CasaDoCodigo.Models
{
    ...
    //O novo cadastro está sendo inserido no banco de dados no arquivo cadastroRepositorie 
    public class Cadastro : BaseModel
    {
        ...
        //inserindo validações nos campos e exibindo mensagens sobre os mesmo para os usuários
        //Validação com [required] e com [min/maxLength]
        //ErrorMessag = mensagem que será exibida para o usuário
